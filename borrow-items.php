                                    ...
                                    <div class="row">
                                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mt-sm-0 mt-3">
                                            <div class="mb-2">
                                                ...
                                                <input type="text" name="inventoryDate" data-provider="flatpickr" data-date-format="d M, Y"
                                                    data-deafult-date="today" class="form-control"
                                                    placeholder="Select Date">
                                            </div>
                                            <div class="mb-2">
                                                <label class="form-label">Due Date :</label>
                                                <input type="text" name="dueDate" data-provider="flatpickr" data-altFormat="F j, Y"
                                                    class="form-control" placeholder="Select Date">
                                            </div>

                                            <div class="mb-2">
                                                <label for="InventoryStatus" class="form-label">Inventory Status</label>
                                                <select class="form-select" id="InventoryStatus" name="InventoryStatus">
                                            ...
                                            <div>
                                                ...
                                                <select class="form-select" id="InventoryCategory" name="InventoryCategory">
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-6">
                                            <div class="mb-4">
                                                ...
                                                <div class="mb-2 pb-1">
                                                    <textarea type="text" id="supplierAddress" name="supplierAddress" rows="3" class="form-control"
                                                        placeholder="Supplier Address"></textarea>
                                                </div>
                                                <div>
                                                    <input type="text" id="supplierNumber" name="supplierNumber" class="form-control"
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mt-sm-0 mt-3">
                                            <div class="mb-4">
                                                ...
                                                <div class="mb-2 pb-1">
                                                    <input type="text" id="borrowerName" name="borrowerName" class="form-control"
                                                        placeholder="Borrower Name">
                                                </div>
                                                <div class="mb-2 pb-1">
                                                    <textarea type="text" id="borrowerAddress" name="borrowerAddress" rows="3" class="form-control"
                                                        placeholder="Borrower Address"></textarea>
                                                </div>
                                                <div>
                                                    <input type="text" id="borrowerNumber" name="borrowerNumber" class="form-control"
                                            ...
                                            <table class="table text-center table-nowrap align-middle mb-0">
                                                <thead>
                                                    <tr class="bg-light bg-opacity-50">
                                                        ...
                                                        <th scope="col" class="border-0 text-start">Item Details</th>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th scope="row">01</th>
                                                        <td class="text-start">
                                                            <input type="text" id="item-detail-one" name="itemDetail[]"
                                                                class="form-control mb-1" placeholder="Item One">
                                                            <input type="text" id="item-desc-one" name="itemDesc[]"
                                                                class="form-control" placeholder="Item description">
                                                        </td>
                                                        <td>
                                                            <input type="number" id="item-quantity-one" name="itemQuantity[]"
                                                        ...
                                                        <td>
                                                            <input type="number" name="itemAmount[]" class="form-control  w-auto"
                                                                placeholder="$0.00">
                                                        </td>
                                                        <td>
                                                            <button type="button"
                                                    ...
                                                    <tr>
                                                        <th scope="row">02</th>
                                                        <td class="text-start">
                                                            <input type="text" id="item-detail-two" name="itemDetail[]"
                                                                class="form-control mb-1" placeholder="Item Two">
                                                            <input type="text" id="item-desc-two" name="itemDesc[]"
                                                                class="form-control" placeholder="Item description">
                                                        </td>
                                                        <td>
                                                            <input type="number" id="item-quantity-two" name="itemQuantity[]"
                                                                class="form-control" placeholder="Quantity">
                                                        </td>
                                                        <td>
                                                            <input type="number" name="itemPrice[]" class="form-control"
                                            ...
                                            <table
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="text-end">
                                                            <div class="ms-auto" style="width: 160px;">
                                                                <input type="number" id="itemSubtotal" name="itemSubtotal"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-end">
                                                            <div class="ms-auto" style="width: 160px;">
                                                                <input type="number" id="itemShipping" name="itemShipping"
                                                                    class="form-control" placeholder="$0.00">
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-end">
                                                            <div class="ms-auto" style="width: 160px;">
                                                                <input type="number" id="itemDiscount" name="itemDiscount"
                                                                    class="form-control" placeholder="$0.00">
                                                            </div>
                                                        </td>
                                                    </tr>
